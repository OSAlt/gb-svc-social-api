...
func (q contactFormQuery) One(ctx context.Context, exec boil.ContextExecutor) (*ContactForm, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "config: failed to execute a one query for contact_form")
	}
...
func (q contactFormQuery) All(ctx context.Context, exec boil.ContextExecutor) (ContactFormSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "config: failed to assign all query results to ContactForm slice")
	}
...
func (q contactFormQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "config: failed to count contact_form rows")
	}
...
func (q contactFormQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "config: failed to check if contact_form exists")
	}
...
func FindContactForm(ctx context.Context, exec boil.ContextExecutor, contactFormID int64, selectCols ...string) (*ContactForm, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "config: unable to select from contact_form")
	}
...
func (o *ContactForm) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("config: no contact_form provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "config: unable to insert into contact_form")
	}
...
func (o *ContactForm) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("config: unable to update contact_form, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "config: unable to update contact_form row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "config: failed to get rows affected by update for contact_form")
	}
...
func (q contactFormQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "config: unable to update all for contact_form")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "config: unable to retrieve rows affected for contact_form")
	}
...
func (o ContactFormSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if len(cols) == 0 {
		return 0, errors.New("config: update all requires at least one column argument")
	}
	...
	if err != nil {
		return 0, errors.Wrap(err, "config: unable to update all in contactForm slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "config: unable to retrieve rows affected all in update all contactForm")
	}
	return rowsAff, nil
}
...
func (o *ContactForm) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("config: no contact_form provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("config: unable to upsert contact_form, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "config: unable to upsert contact_form")
	}
...
func (o *ContactForm) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("config: no ContactForm provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "config: unable to delete from contact_form")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "config: failed to get rows affected by delete for contact_form")
	}
...
func (q contactFormQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("config: no contactFormQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "config: unable to delete all from contact_form")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "config: failed to get rows affected by deleteall for contact_form")
	}
...
func (o ContactFormSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "config: unable to delete all from contactForm slice")
	}
...
func (o *ContactFormSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "config: unable to reload all in ContactFormSlice")
	}
...
func ContactFormExists(ctx context.Context, exec boil.ContextExecutor, contactFormID int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "config: unable to check if contact_form exists")
	}
